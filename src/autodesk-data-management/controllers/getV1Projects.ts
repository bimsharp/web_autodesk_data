...
import models = require('../models/getV1Projects');
import validators = require('../validators/getV1Projects');
import * as AutodeskError from '../../shared/models/AutodeskError';
import * as BuiltInError from '../../shared/models/BuiltInError';

/**
 * Wrapper for Autodesk API at https://aps.autodesk.com/en/docs/data/v2/reference/http/hubs-hub_id-projects-GET/
 * @returns {AutodeskProjects | AutodeskError | BuiltInError}
 */
export async function get(params: models.GetAutodeskProjects_Payload) {
    ...
    const url = `${process.env.AUTODESK_BASE_URL}/project/v1/hubs/${params.autodesk_hub_id}/projects`;
    ...
    let result = await axios
        ...
        .then(response => new models.AutodeskProjects(response?.data))
